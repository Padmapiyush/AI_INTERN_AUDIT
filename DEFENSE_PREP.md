...
If asked: *"Where did 27 concurrent sequences come from?"*
...
5. Cache per sequence = `114,688 * 4096 = 469,762,048 bytes (0.4375 GB)`
6. Result: `12.08 / 0.4375 = 27.6` → Floor to **27 sequences**.
...
1. Have a terminal open in `z:\FLAM\submission\partA\`
...
- [ ] Terminal open, `cd` into `z:\FLAM\submission\partA`
